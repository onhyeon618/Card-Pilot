...
object CardPilotColors {
    ...
    val OutlineInput = Color(0xFFFFFFFF).copy(alpha = 0.7f)
    val OutlineButton = Color(0xFFFFFFFF).copy(alpha = 0.9f)
    val SurfaceGlass = Color(0xFFFFFFFF).copy(alpha = 0.4f) // 40% opacity for strong glass effect
    val SurfaceGlassInput = Color(0xFFFFFFFF).copy(alpha = 0.6f)
    val SurfaceGlassButton = Color(0xFFFFFFFF).copy(alpha = 0.75f)
